...
<div class="land">
    <div class="bg-2">
        <div class="row">
            <div class="col-12">
                <h1 class="text-center"> Form Tambah Data Tugas Akhir </h1>
            </div>
...
<form action='{{ route('skripsi.store') }}' method='post' enctype="multipart/form-data">
    @csrf
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select class="form-select form" aria-label="Default select example" name='dosen2_id' value="{{ Session::get('dosen2_id')}}" id="dosen2_id">
                    <option selected>.</option>
                    <option value="1">Dania Eridani S.T., M.Eng</option>
                    <option value="2">Dr. Adian Fatchur Rochim, S.T., M.T. SMIEEE</option>
                    <option value="3">Eko Didik Widianto S.T., M.T.</option>
