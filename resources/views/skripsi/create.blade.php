...
<title>Halaman Create Data TA</title>
<div>
    <h1>Ini halaman TA khusus admin</h1>
    <a href="/skripsi/update_admin" class="btn btn-info">Kembali</a>
</div>
<form action='{{ route('skripsi.store') }}' method='post' enctype="multipart/form-data">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            <label for="dosen_id" class="col-sm-2 col-form-label">Nama Dosen Pembimbing I</label>
            <div class="col-sm-10">
        ...
        <div class="mb-3 row">
            <label for="dosen2_id" class="col-sm-2 col-form-label">Nama Dosen Pembimbing II</label>
            <div class="col-sm-10">
                <select class="form-select" aria-label="Default select example" name='dosen2_id' value="{{ Session::get('dosen2_id')}}" id="dosen2_id">
                    <option selected>.</option>
                    <option value="1">Dania Eridani S.T., M.Eng</option>
                    <option value="2">Dr. Adian Fatchur Rochim, S.T., M.T. SMIEEE</option>
                    <option value="3">Eko Didik Widianto S.T., M.T.</option>
