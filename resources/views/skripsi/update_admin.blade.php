        ...
        <div class="bg-2" style="max-height: 50%">
            <div class="row" style="margin-left: 0%">
                <div class="col-sm-9" style="margin-top: 2%">
                    <a href="/skripsi/update_admin/create" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <form onsubmit="return confirm('Yakin ingin menghapus semua data ?')" class="d-inline" action="{{ route('buku.delete_all') }}" method="POST">
                        @csrf
                    ...
                    <div class="my-3 p-3 bg-body rounded shadow-sm">
                        ...
                        <form action="/skripsi/update_admin" method="get">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-1">
                                    <a> <br> </a>
                                    <a href='/skripsi/update_admin' class="btn btn-danger">
...
<div id="land_header">
    <h1 class="index_header">Halaman Admin: Skripsi</h1>
</div>
            ...
            <tbody class="content_table">
                @foreach ($joins as $join)
                    <tr class="link_detail">
                        ...
                        <td>
                            @if ($join->file)
                                <a class="btn btn-success btn-sm" href="{{ asset('storage/pdf/skripsi/'. $join->file)}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
                        ...
                        <td>
                            <a href='{{ url('/skripsi/update_admin/edit/'.$join->id_skripsi) }}' class="btn btn-warning btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16"
