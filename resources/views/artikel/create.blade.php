...
<form action='{{ route('artikel.store') }}' method='post'>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select class="form-select" aria-label="Default select example" name='jenis_artikel' value="{{ Session::get('jenis_artikel')}}" id="jenis_artikel">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" name='waktu_artikel' value="{{ Session::get('waktu_artikel')}}" id="waktu_artikel">
            </div>
        </div>
        {{-- Isi --}}
        <div class="mb-3">
            ...
            <trix-editor input="isi_artikel" value="{{ Session::get('isi_artikel')}}" id="isi_artikel"></trix-editor>
        </div>
        <div class="mb-3 row">
