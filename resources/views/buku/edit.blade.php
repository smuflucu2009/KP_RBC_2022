...
@section('isi_template')
    ...
    <body>
                ...
                <div class="row" style="margin-left: 0%">
                    ...
                    <p>
                        <a class="btn" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false"
                            ...
                            Fitur Lanjutan <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
        ...
        <div>
            ...
            <h1>Admin buku {{ $data->judul_buku }}</h1>
        </div>
    </body>
@endsection
