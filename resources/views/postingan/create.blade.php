...
<form action='{{ route('postingan.store') }}' method='post' enctype="multipart/form-data">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select class="form-select" aria-label="Default select example" name='category_id' value="{{ Session::get('category_id')}}" id="category_id">
        ...
        <div class="mb-3">
            <label for="deskripsi" class="form-label">Isi Postingan</label>
            <input id="deskripsi" type="hidden" name="deskripsi">
            <trix-editor input="deskripsi" value="{{ Session::get('deskripsi')}}" id="deskripsi"></trix-editor>
        </div>
        <div class="mb-3 row">
