...
<form action='{{ route('kp.update', $joins->id_kp) }}' method='post' enctype="multipart/form-data">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='perusahaan' value="{{ $joins->perusahaan }}" id="perusahaan">
            </div>
        </div> 
        <div class="mb-3 row">
            <label for="lokasi_perusahaan" class="col-sm-2 col-form-label">Alamat Perusahaan</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='lokasi_perusahaan' value="{{ $joins->lokasi_perusahaan }}" id="lokasi_perusahaan">
            </div>
        </div>
        <div class="mb-3 row">
