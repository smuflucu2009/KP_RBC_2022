        ...
        <tbody>
            ...
            @foreach ($joins as $join)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('kp.restore', $join->id) }}" class="btn btn-primary btn-sm">Restore</a>
                        <form onsubmit="return confirm('Yakin ingin menghapus permanen data KP ini?')" class="d-inline" action="{{ route('kp.delete', $join->id) }}" method="post">
                            @csrf
