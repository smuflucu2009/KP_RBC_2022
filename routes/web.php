...
route::get('/skripsi/detail/{id}', [SkripsiController::class, 'detail_skripsi'])->name('skripsi.detail_skripsi')->middleware('isLogin');

route::get('/kp', [KpController::class, 'index'])->name('kp.index');
route::get('/kp/detail/{id}', [KpController::class, 'detail_kp'])->name('kp.detail_kp')->middleware('isLogin');
